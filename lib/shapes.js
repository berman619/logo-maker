...
class Triangle extends Shape {
    ...
    render() {
      return `<svg xmlns="http://www.w3.org/2000/svg" width="300" height="200">
              ...
              <text x="150" y="120" dominant-baseline="middle" text-anchor="middle" fill="${this.textColor}">${this.text}</text>
              </svg>`;
    }
}
...
class Circle extends Shape {
    ...
    render() {
        return `<svg xmlns="http://www.w3.org/2000/svg" width="300" height="200">
                <circle r="${this.radius}" cx="150" cy="100" fill="${this.color}" />
                <text x="150" y="100" dominant-baseline="middle" text-anchor="middle" fill="${this.textColor}">${this.text}</text>
                </svg>`;
    }
}  
